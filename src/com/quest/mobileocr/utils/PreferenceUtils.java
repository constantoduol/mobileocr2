...
public class PreferenceUtils {
     ...
     * </p>
     *
     * @param context Contexts from which the preferences are loaded.
     * @param preferenceKey Preference key
     * @param defaultValue Default value to return if there is no preference
     * with the key {@code preferenceKey}.
